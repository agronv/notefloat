...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/birdy.jpg')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/smells_like_teen_spirit.jpg')
t7.photo.attach(io: file, filename: 'smells_like_teen_spirit.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/smells_like_teen_spirit.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/mozart.jpg')
t8.photo.attach(io: file, filename: 'mozart.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/lacrimosa.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/tchaikovsky.jpg')
t9.photo.attach(io: file, filename: 'tchaikovsky.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/valse_sentimentale.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/gold_digger.jpg')
t10.photo.attach(io: file, filename: 'gold_digger.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/gold_digger.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/bohemain.jpg')
t11.photo.attach(io: file, filename: 'bohemain.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/bohemian_rhapsody.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/animals.jpg')
t12.photo.attach(io: file, filename: 'animals.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/animals.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/mr.brightside.jpg')
t13.photo.attach(io: file, filename: 'mr.brightside.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/mr_brightside.mp3')
t13.mp3_file.attach(io: track, filename: 'mr_brightside.mp3')
t13.save!

t14 = Track.new({title: "One Kiss", user_id: u7.id, genre: 'pop', length: 212})
file = EzDownload.open('https://notefloat.s3.amazonaws.com/one_kiss.jpg')
t14.photo.attach(io: file, filename: 'one_kiss.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/one_kiss.mp3')
t14.mp3_file.attach(io: track, filename: 'one_kiss.mp3')
t14.save!

t15 = Track.new({title: "Changes", user_id: u3.id, genre: 'rap', length: 270})
file = EzDownload.open('https://notefloat.s3.amazonaws.com/changes.jpg')
t15.photo.attach(io: file, filename: 'changes.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/changes.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/come_together.jpg')
t16.photo.attach(io: file, filename: 'come_together.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/come_together.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/sandstorm.jpeg')
t17.photo.attach(io: file, filename: 'sandstorm.jpeg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/sandstorm.mp3')
t17.mp3_file.attach(io: track, filename: 'sandstorm.mp3')
t17.save!

t18 = Track.new({title: "Havana", user_id: u4.id, genre: 'pop', length: 218})
file = EzDownload.open('https://notefloat.s3.amazonaws.com/havana.jpg')
t18.photo.attach(io: file, filename: 'havana.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/havana.mp3')
t18.mp3_file.attach(io: track, filename: 'havana.mp3')
t18.save!

t19 = Track.new({title: "Big Poppa", user_id: u4.id, genre: 'rap', length: 249})
file = EzDownload.open('https://notefloat.s3.amazonaws.com/big_poppa.jpg')
t19.photo.attach(io: file, filename: 'big_poppa.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/big_poppa.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/gimme_shelter.jpg')
t20.photo.attach(io: file, filename: 'gimme_shelter.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/gimme_shelter.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/wonderwall.jpg')
t21.photo.attach(io: file, filename: 'wonderwall.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/wonderwall.mp3')
t21.mp3_file.attach(io: track, filename: 'wonderwall.mp3')
t21.save!

t22 = Track.new({title: "Love Song", user_id: u5.id, genre: 'pop', length: 236})
file = EzDownload.open('https://notefloat.s3.amazonaws.com/love_song.jpg')
t22.photo.attach(io: file, filename: 'love_song.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/love_song.mp3')
t22.mp3_file.attach(io: track, filename: 'love_song.mp3')
t22.save!

t23 = Track.new({title: "No Role Modelz", user_id: u5.id, genre: 'rap', length: 293})
file = EzDownload.open('https://notefloat.s3.amazonaws.com/j.cole.jpg')
t23.photo.attach(io: file, filename: 'j.cole.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/no_role_modelz.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/girl_like_you.jpg')
t24.photo.attach(io: file, filename: 'girl_like_you.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/girl_like_you.mp3')
t24.mp3_file.attach(io: track, filename: 'girl_like_you.mp3')
t24.save!

t25 = Track.new({title: "Levels", user_id: u5.id, genre: 'techno', length: 333})
file = EzDownload.open('https://notefloat.s3.amazonaws.com/wake_me_up.jpg')
t25.photo.attach(io: file, filename: 'wake_me_up.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/levels.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/radioactive.jpg')
t26.photo.attach(io: file, filename: 'radioactive.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/radioactive.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/valykries.jpg')
t27.photo.attach(io: file, filename: 'valykries.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/ride_of_the_valykries.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/uptown_funk.jpg')
t28.photo.attach(io: file, filename: 'uptown_funk.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/uptown_funk.mp3')
t28.mp3_file.attach(io: track, filename: 'uptown_funk.mp3')
t28.save!

t29 = Track.new({title: "Too Good", user_id: u6.id, genre: 'rap', length: 265})
file = EzDownload.open('https://notefloat.s3.amazonaws.com/views.jpg')
t29.photo.attach(io: file, filename: 'views.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/too_good.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/debussy.jpg')
t30.photo.attach(io: file, filename: 'debussy.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/clair_de_lune.mp3')
t30.mp3_file.attach(io: track, filename: 'clair_de_lune.mp3')
t30.save!

t31 = Track.new({title: "Runaway", user_id: u6.id, genre: 'techno', length: 227})
file = EzDownload.open('https://notefloat.s3.amazonaws.com/runaway.jpg')
t31.photo.attach(io: file, filename: 'runaway.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/Runaway.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/sound_and_color.png')
t32.photo.attach(io: file, filename: 'sound_and_color.png')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/sound_and_color.mp3')
...
file = EzDownload.open('https://notefloat.s3.amazonaws.com/blue_waltz.jpg')
t33.photo.attach(io: file, filename: 'blue_waltz.jpg')
track = EzDownload.open('https://notefloat.s3.amazonaws.com/blue_danube_waltz.mp3')
